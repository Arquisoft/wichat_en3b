...
const rankings = [
    { rank: 1, name: "Sarah Kim", points: 7250, avatar: "/placeholder.svg?height=40&width=40" },
    { rank: 2, name: "Mike Chen", points: 6840, avatar: "/placeholder.svg?height=40&width=40" },
    { rank: 3, name: "Taylor Swift", points: 6210, avatar: "/placeholder.svg?height=40&width=40" },
    { rank: 4, name: "Alex Johnson", points: 4850, avatar: "/placeholder.svg?height=40&width=40", isCurrentUser: true },
    { rank: 5, name: "Jordan Lee", points: 4720, avatar: "/placeholder.svg?height=40&width=40" },
]
            ...
            <Container maxWidth="lg" sx={{ py: 4 }}>
                ...
                <Box sx={{ mb: 4 }}>
                    ...
                    <TabPanel value={activeTab} index={1}>
                        ...
                        >
                            <CardHeader title="Global Leaderboard" subheader="Top players ranked by total points" />
                            <CardContent>
                                <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
                                    {rankings.map((player) => (
                                        <Paper
                                            ...
                                            <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                                                ...
                                                >
                                                    {player.rank <= 3 ? (
                                                        <MedalIcon
                                                            sx={{
                                                                color: player.rank === 1 ? "gold" : player.rank === 2 ? "silver" : "#cd7f32", // bronze
                                                            }}
                                                        />
                                                    ) : (
